...
export function Footer() {
  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      ...
      toast.success("You're in! 🔥", { description: "Check your inbox for exclusive drops." })
      setEmail("")
    }, 1500)
  }
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <p className="text-white/60 font-mono text-xs max-w-xl mx-auto leading-relaxed">
            Volt Energy is a better-for-you energy drink crafted with natural flavors, zero sugar, and a clean energy
        ...
        >
          ...
          <p className="text-white/40 font-mono text-xs">© 2026 Volt Energy. All rights reserved.</p>
