...
const activations = [
  {
    ...
    description: "Experience Volt at exclusive tasting events near you.",
    cta: "Find Events",
  },
  {
    icon: Dumbbell,
  ...
  },
  {
    ...
    description: "Sponsor your next event with Volt energy.",
    cta: "Sponsor Event",
  },
]
    ...
    <section id="distributors" className="relative py-16 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            From tasting events to corporate partnerships, bring Volt into your world.
          </motion.p>
        </motion.div>
